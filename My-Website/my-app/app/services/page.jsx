		...
		<section class="bg-white">
			<div class="lg:grid lg:min-h-screen lg:grid-cols-12">
				<section class="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
					<img
						alt="Night"
						src="https://www.google.com/url?sa=i&url=https%3A%2F%2Ftwitter.com%2FResimVesaire&psig=AOvVaw3qfDzPvSmCkJnUg8wrrkLd&ust=1704475039112000&source=images&cd=vfe&opi=89978449&ved=0CBEQjRxqFwoTCOitgMOexIMDFQAAAAAdAAAAABAt"
